...
LEGAL_ACTIVITIES = [download_pdf, split_pages, analyze_batch, merge_advice, human_followup, upload_advice]

# every activity, for a worker that serves both queues
ALL_ACTIVITIES = PDF_ACTIVITIES + [split_pages, analyze_batch, merge_advice, human_followup, upload_advice]
