...
the most precise location. Keep every distinct risk: dropping one is worse than \
repeating yourself. The summary should describe the whole document, not the \
...
{
  "summary": "...",
  "key_risks": [{"description": "...", "severity": "...", "location": "..."}],
  "needs_human": false,
  "question": ""
}
