...
LEGAL_WORKFLOW_ID_PREFIX = "legal-review-"
...
def legal_workflow_id_for(task_id: str) -> str:
    """`a1b2c3d4` -> `legal-review-a1b2c3d4`."""
    return f"{LEGAL_WORKFLOW_ID_PREFIX}{task_id}"


def legal_task_id_from(workflow_id: str) -> str:
    """`legal-review-a1b2c3d4` -> `a1b2c3d4`; unprefixed ids are returned as-is."""
    return workflow_id.removeprefix(LEGAL_WORKFLOW_ID_PREFIX)
